...
namespace GLib
{
    ...
    public partial class Source : GLib.Opaque
    {
        ...
        [DllImport(Global.GLibNativeDll, CallingConvention = CallingConvention.Cdecl)]
        static extern void g_source_set_callback(IntPtr source,
                                                GSourceFunc func,
                                                IntPtr data,
                                                IntPtr gDestroyNotify);

        public void SetCallback(GSourceFunc func, IntPtr data, IntPtr gDestroyNotify)
        {
            g_source_set_callback(Raw, func, data, gDestroyNotify);
        }
