...
namespace Gst {
	...
	public partial class Pad : Gst.Object {
		...
		[DllImport(DLL.GStreamer, CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr gst_pad_add_probe(IntPtr raw, int mask, GstSharp.PadProbeCallbackNative cb, IntPtr user_data, GLib.DestroyNotify destroy_data);

		[DllImport(DLL.GStreamer, CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr gst_pad_add_probe(IntPtr raw, int mask, GstSharp.PadProbeCallbackNative cb, IntPtr user_data, IntPtr destroy_data);
		...
		[DllImport(DLL.GStreamer, CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr gst_pad_get_current_caps(IntPtr raw);
		...
		[DllImport(DLL.GStreamer, CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr gst_pad_query_caps(IntPtr raw, IntPtr filter);
