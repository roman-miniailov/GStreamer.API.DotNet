...
namespace Gst.Video {
	...
	public partial class VideoOverlayAdapter : GLib.GInterfaceAdapter, Gst.Video.IVideoOverlay {
		...
		[DllImport(DLL.GstVideo, CallingConvention = CallingConvention.Cdecl)]
		public static extern void gst_video_overlay_expose(IntPtr raw);
		...
		[DllImport(DLL.GstVideo, CallingConvention = CallingConvention.Cdecl)]
		public static extern void gst_video_overlay_set_window_handle(IntPtr raw, IntPtr handle);
		...
		private static extern IntPtr g_type_check_instance_cast(IntPtr instance, IntPtr iface_type);

		//[DllImport(DLL.GstVideo, CallingConvention = CallingConvention.Cdecl, EntryPoint = "API_GST_VIDEO_OVERLAY")]
		//public static extern IntPtr GST_VIDEO_OVERLAY(IntPtr raw);

		public static IntPtr GST_VIDEO_OVERLAY(IntPtr raw)
        {
            return g_type_check_instance_cast(raw, gst_video_overlay_get_type());

			//return _G_TYPE_CIC((obj), , GstVideoOverlay);
        }
