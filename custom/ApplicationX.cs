...
namespace Gst
{
    ...
    partial class Application
    {
        ...
        [DllImport(DLL.GStreamer, CallingConvention = CallingConvention.Cdecl)]
        static extern void gst_android_init(IntPtr jnienv, IntPtr gstreamerObject, IntPtr context);
...
#if __ANDROID__
        public static void Init(IntPtr jnienv, IntPtr context)
        {
            //gst_init(IntPtr.Zero, IntPtr.Zero);
            gst_android_init(jnienv, IntPtr.Zero, context);
            CheckVersion();
        }
#elif __IOS__
        [DllImport(DLL.GStreamer, CallingConvention = CallingConvention.Cdecl)]
        static extern void gst_ios_init(IntPtr argc, IntPtr argv);

        public static void Init()
        {
            gst_ios_init(IntPtr.Zero, IntPtr.Zero);

            //var glPlatform = Environment.GetEnvironmentVariable("GST_GL_PLATFORM");
            Environment.SetEnvironmentVariable("GST_GL_PLATFORM", "eagl");
